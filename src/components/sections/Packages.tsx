...
const packages = [
  ...
  },
  {
    ...
    description: "Up to 3 custom workflows built, tested and deployed.",
    features: [
      "3 custom workflows built end-to-end",
      "Make.com / n8n / Zapier integration",
      "OpenAI + GPT-4 connections",
      "Full documentation & handover",
      "30-day fix guarantee",
    ],
    cta: "Get Started",
    popular: true,
    note: "Delivered in 7 days or it's free.",
  },
  {
    name: "Scale",
    price: "$1,499",

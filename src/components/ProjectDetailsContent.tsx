...
const ProjectDetailsContent = ({ initialActiveTab = 's1' }: Props) => {
  ...
  return (
    <div className="flex flex-col">
      <div className="project-details-page flex-grow">
        {/* The content */}
  ...
  <div className="w-full max-w-xl flex items-center gap-4">
    ...
    <div className="w-full">
      <Select value={activeTab} onValueChange={handleTabClick}>
        <SelectTrigger className="w-full bg-secondary/30 border border-primary-glow/35 text-foreground shadow-[0_0_15px_-3px_rgba(167,139,250,0.25)] hover:bg-secondary/50 hover:border-primary-glow/65 hover:shadow-[0_0_25px_-3px_rgba(167,139,250,0.5)] transition-all duration-300 h-11 px-5">

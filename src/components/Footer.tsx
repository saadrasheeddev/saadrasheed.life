        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
          <div className="flex items-center gap-2">
            <div className="h-9 w-9 rounded-lg gradient-primary flex items-center justify-center p-1.5">
              <img src={logoS.src || logoS} alt="Saad Rasheed logo" width={36} height={36} loading="lazy" className="h-full w-full object-contain brightness-0 invert" />
            </div>
          ...
          <nav className="flex flex-wrap items-center gap-6 text-sm text-muted-foreground">
            ...
            <a href="https://blog.saadrasheed.life" className="hover:text-foreground transition-colors">Blog</a>
          </nav>
